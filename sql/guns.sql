...
-- ----------------------------
-- Table structure for business_province
-- ----------------------------
DROP TABLE IF EXISTS `business_province`;
CREATE TABLE `business_province`  (
  `province_id` bigint(20) NOT NULL COMMENT '主键id',
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '地市表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of business_province
-- ----------------------------
INSERT INTO `business_province` VALUES (24, 0, '[0],', '冀', '河北省', '', NULL, 1, NULL, NULL, NULL, NULL);
INSERT INTO `business_province` VALUES (25, 24, '[0],[24],', '保定市', '保定市', '', NULL, 2, NULL, NULL, NULL, NULL);
INSERT INTO `business_province` VALUES (26, 24, '[0],[24],', '石家庄市', '石家庄市', '', NULL, 3, NULL, NULL, NULL, NULL);
...
INSERT INTO `sys_menu` VALUES (173, 'province', 'dashboard', '[0],[dashboard],', '省市管理', NULL, '/province', 3, 2, 'Y', NULL, 'ENABLE', NULL, NULL, NULL, '2019-03-29 16:32:27', NULL, 1);
INSERT INTO `sys_menu` VALUES (174, 'province_add', 'province', '[0],[dashboard],[province],', '添加省市', NULL, '/province/add', 1, 3, 'N', NULL, 'ENABLE', NULL, NULL, NULL, '2019-03-29 16:32:27', NULL, 1);
INSERT INTO `sys_menu` VALUES (175, 'province_update', 'province', '[0],[dashboard],[province],', '修改省市', NULL, '/province/update', 1, 3, 'N', NULL, 'ENABLE', NULL, NULL, NULL, '2019-03-29 16:32:27', NULL, 1);
INSERT INTO `sys_menu` VALUES (176, 'province_delete', 'province', '[0],[dashboard],[province],', '删除省市', NULL, '/province/delete', 1, 3, 'N', NULL, 'ENABLE', NULL, NULL, NULL, '2019-03-29 16:32:27', NULL, 1);
INSERT INTO `sys_menu` VALUES (177, 'to_province_update', 'province', '[0],[dashboard],[province],', '修改省市跳转', '', '/province/province_update', 4, 3, 'N', NULL, 'ENABLE', NULL, NULL, NULL, '2019-03-29 16:32:27', NULL, 1);
INSERT INTO `sys_menu` VALUES (178, 'province_list', 'province', '[0],[dashboard],[province],', '省市列表', '', '/province/list', 5, 3, 'N', NULL, 'ENABLE', NULL, NULL, NULL, '2019-03-29 16:32:27', NULL, 1);
INSERT INTO `sys_menu` VALUES (179, 'province_detail', 'province', '[0],[dashboard],[province],', '省市详情', '', '/province/detail', 6, 3, 'N', NULL, 'ENABLE', NULL, NULL, NULL, '2019-03-29 16:32:27', NULL, 1);

INSERT INTO `sys_menu` VALUES (180, 'project', 'dashboard', '[0],[dashboard],', '项目管理', NULL, '/project', 3, 2, 'Y', NULL, 'ENABLE', NULL, NULL, NULL, '2019-03-29 16:32:27', NULL, 1);
INSERT INTO `sys_menu` VALUES (181, 'project_add', 'project', '[0],[dashboard],[project],', '添加项目', NULL, '/project/add', 1, 3, 'N', NULL, 'ENABLE', NULL, NULL, NULL, '2019-03-29 16:32:27', NULL, 1);
INSERT INTO `sys_menu` VALUES (182, 'project_update', 'project', '[0],[dashboard],[project],', '修改项目', NULL, '/project/update', 1, 3, 'N', NULL, 'ENABLE', NULL, NULL, NULL, '2019-03-29 16:32:27', NULL, 1);
INSERT INTO `sys_menu` VALUES (183, 'project_delete', 'project', '[0],[dashboard],[project],', '删除项目', NULL, '/project/delete', 1, 3, 'N', NULL, 'ENABLE', NULL, NULL, NULL, '2019-03-29 16:32:27', NULL, 1);
INSERT INTO `sys_menu` VALUES (184, 'to_project_update', 'project', '[0],[dashboard],[project],', '修改项目跳转', '', '/project/project_update', 4, 3, 'N', NULL, 'ENABLE', NULL, NULL, NULL, '2019-03-29 16:32:27', NULL, 1);
...
CREATE TABLE `business_project`  (
  ...
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '项目名称',
  `province_id` bigint(20) DEFAULT NULL COMMENT '省市',
  `create_time` datetime(0) DEFAULT NULL COMMENT '创建时间',
  `create_user` bigint(20) DEFAULT NULL COMMENT '创建人',
  `update_time` datetime(0) DEFAULT NULL COMMENT '修改时间',
  `update_user` bigint(20) DEFAULT NULL COMMENT '修改人',
...
-- ----------------------------
-- Table structure for business_application_form
-- ----------------------------
DROP TABLE IF EXISTS `business_application_form`;
CREATE TABLE `business_application_form`  (
  ...
  `receive_user` bigint(20) DEFAULT NULL COMMENT '接收人',
  `create_time` datetime(0) DEFAULT NULL COMMENT '创建时间',
  `create_user` bigint(20) DEFAULT NULL COMMENT '创建人',
  `update_time` datetime(0) DEFAULT NULL COMMENT '修改时间',
  `update_user` bigint(20) DEFAULT NULL COMMENT '修改人',
...
CREATE TABLE `business_statistic`  (
  ...
  `out_patient_num` bigint(20) DEFAULT NULL COMMENT '就医方式 门诊数量',
  `hospital_num` bigint(20) DEFAULT NULL COMMENT '就医方式 住院数量',
